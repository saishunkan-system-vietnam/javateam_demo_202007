      ...
      <div class="app-main__outer" style="padding-left: 0px;">
        <div class="app-main__inner">
          <v-tabs v-model="activeTab" grow>
            <v-tab v-for="tab of tabs" :key="tab.id" :to="tab.route" exact>{{ tab.name }}</v-tab>
...
export default {
  ...
  data() {
    return {
      ...
      activeTab: `/`,
      tabs: [
        { id: 1, name: "Analytics", route: `/` },
        { id: 2, name: "Advertisement", route: `/dashboards/advertisement` },
        { id: 3, name: "Management", route: `/dashboards/management` },
        { id: 4, name: "Helpdesk", route: `/dashboards/helpdesk` },
        { id: 5, name: "Monitoring", route: `/dashboards/monitoring` },
        { id: 6, name: "Crypto", route: `/dashboards/crypto` },
        { id: 7, name: "Project", route: `/dashboards/project-management` },
        { id: 8, name: "Product", route: `/dashboards/product` },
        { id: 9, name: "Statistics", route: `/dashboards/statistics` }
      ]
    };
  }
};
